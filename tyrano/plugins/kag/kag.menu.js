tyrano.plugin.kag.menu = {
    ...
    showMenu: function (call_back) {
      ...
      this.kag.html("menu", {
        ...
        //cgモードへのリンク追加
        layer_menu.find(".menu_cg").click(function () {
          that.displayCg();
          layer_menu.hide();
        });
      ...
      this.kag.html("save", {
        ...
        j_save.find(".save_display_area").each((function () {
          $(this).click((function (e) {
            ...
            //セーブを通知
            TYRANO.kag.ftag.startTag("sleepgame", {storage: "dialog.ks",target: "*doSaveNotification"});
          }))
        }));
    ...
    //タイトルへ戻る
    backTitle:function() {
      TYRANO.kag.ftag.startTag("sleepgame", {storage:"dialog.ks",target:"*backtitle"})
  },
    //cgモードを表示する処理
    displayCg:function() {
      TYRANO.kag.ftag.startTag("sleepgame", {storage: "cg.ks"})
  },
