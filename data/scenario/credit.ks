...
[ptext layer=0 text="中西健太・森大樹・山内柔磨" size=45 x=0 y=2500 color=snow name="text"]
...
[ptext layer=0 text="ティラノスクリプトのデフォルトプロジェクト" size=45 x=0 y=11800 color=snow name="text"]

[ptext layer=0 text="ティラノスクリプト用プラグイン" size=55 x=0 y=12000 color=snow name="text"]
[ptext layer=0 text="さくた（@skt_order）｜https：//skt-pnt.netlify.app" size=45 x=0 y=12100 color=snow name="text"]
[ptext layer=0 text="・ティラノスタジオ用デバッグ支援プラグイン" size=45 x=0 y=12200 color=snow name="text"]
[ptext layer=0 text="・ゲーム終了時確認ダイアログ表示プラグイン" size=45 x=0 y=12300 color=snow name="text"]
[ptext layer=0 text="・スライダーUIプラグイン" size=45 x=0 y=12400 color=snow name="text"]
[ptext layer=0 text="・一文単位で既読判定するプラグイン" size=45 x=0 y=12500 color=snow name="text"]

[ptext layer=0 text="Astro Pants (https://tarowimo.outside-i.com/)" size=45 x=0 y=12700 color=snow name="text"]
[ptext layer=0 text="・AUTO/SKIPアイコン表示プラグイン" size=45 x=0 y=12800 color=snow name="text"]

[ptext layer=0 text="めも調（http://hororo.wp.xdomain.jp/）" size=45 x=0 y=13000 color=snow name="text"]
[ptext layer=0 text="・メニューSE追加プラグイン" size=45 x=0 y=13100 color=snow name="text"]

[ptext layer=0 text="myokoym（https://twitter.com/myokoym）" size=45 x=0 y=13300 color=snow name="text"]
[ptext layer=0 text="・tyranoscript-plugin-glinks" size=45 x=0 y=13400 color=snow name="text"]

[ptext layer=0 text="（猫）milkcat　https://milkcat.jp/" size=45 x=0 y=13600 color=snow name="text"]
[ptext layer=0 text="・システムスワイププラグイン" size=45 x=0 y=13700 color=snow name="text"]

[ptext layer=0 text="クレジット・エンディング使用曲" size=65 x=0 y=14000 color=snow name="text"]

[ptext layer=0 text="曲名「Yours」（製作者：ISAo　様）" size=45 x=0 y=14100 color=snow name="text"]
[ptext layer=0 text="楽曲URL：https://dova-s.jp/bgm/play2217.html" size=45 x=0 y=14200 color=snow name="text"]



[ptext layer=0 text="スペシャルサンクス" size=65 x=0 y=14500 color=snow name="text"]
[ptext layer=0 text="鈴木かおり　先生" size=45 x=0 y=14600 color=snow name="text"]
[ptext layer=0 text="鈴木滋　先生" size=45 x=0 y=14700 color=snow name="text"]
[ptext layer=0 text="牧之原市 産業経済部 商工観光課　御中" size=45 x=0 y=14800 color=snow name="text"]
[ptext layer=0 text="牧之原市 建設部 公園公共建築課　御中" size=45 x=0 y=14900 color=snow name="text"]
[ptext layer=0 text="森木農園　御中" size=45 x=0 y=15000 color=snow name="text"]
[ptext layer=0 text="さがら子生れ温泉会館　御中" size=45 x=0 y=15100 color=snow name="text"]
[ptext layer=0 text="中日本エクシス株式会社静岡支店　御中" size=45 x=0 y=15200 color=snow name="text"]
[ptext layer=0 text="静岡県スポーツ・文化観光部　空港振興局　空港管理課　御中" size=45 x=0 y=15300 color=snow name="text"]
[ptext layer=0 text="株式会社TOMA　牧之原乗馬クラブ　御中" size=45 x=0 y=15400 color=snow name="text"]

[ptext layer=0 text="この作品の制作に協力してくださった皆様" size=65 x=0 y=15600 color=snow name="text"]
[ptext layer=0 text="この作品をプレイしてくださった皆様" size=65 x=0 y=15700 color=snow name="text"]

[ptext layer=0 text="本当にありがとうございました" size=65 x=0 y=15900 color=snow name="text"]
